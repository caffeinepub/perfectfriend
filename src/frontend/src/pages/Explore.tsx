...
import { clearPendingNewReel, pendingNewReel } from "../stores/newReelStore";
...
const EXPLORE_REELS: Reel[] = [
  {
    id: "e1",
    user: MOCK_USERS[2],
    videoUrl: "/assets/video_1-019d3fcb-2382-712d-b6ee-bcfe77659a39.mp4",
    reelName: "City Nights 🌃",
    caption: "Nothing beats city lights at night 🌃✨ Pure magic!",
    hashtags: ["#CityNights", "#Trending", "#Explore"],
    taggedUsers: [],
    songName: "Pasoori - Ali Sethi",
    likes: 12300,
    comments: 867,
    isLiked: false,
  },
  {
    ...
    user: MOCK_USERS[0],
    videoUrl: "/assets/video_1-019d3fcb-2382-712d-b6ee-bcfe77659a39.mp4",
    reelName: "Travel Diary ✈️",
    caption:
      "New places, new memories! 🗺️ Every journey is a story worth telling",
    hashtags: ["#Travel", "#Explore", "#Wanderlust"],
    taggedUsers: ["@rahul_verma"],
  ...
  },
  {
    ...
    videoUrl: "/assets/video_1-019d3fcb-2382-712d-b6ee-bcfe77659a39.mp4",
    reelName: "Food Vibes 🍕",
    caption: "When food is love, share it with everyone! 🍕❤️ Yum yum yum!",
    hashtags: ["#FoodLover", "#Yummy", "#Trending"],
    taggedUsers: [],
    songName: "Kalaastar - Honey Singh",
    likes: 3890,
    comments: 201,
    isLiked: false,
  },
...
export default function Explore() {
  ...
  const [reels, setReels] = useState<Reel[]>(EXPLORE_REELS);
  ...
  // Check for pending reel from camera recorder on mount
  useEffect(() => {
    if (pendingNewReel) {
      const pr = pendingNewReel;
      const newReel: Reel = {
        id: pr.id,
        user: CURRENT_USER,
        videoUrl: pr.videoUrl,
        reelName: pr.reelName,
        caption: pr.caption,
        hashtags: pr.hashtags,
        taggedUsers: pr.taggedUsers,
        songName: pr.songName,
        likes: 0,
        comments: 0,
        isLiked: false,
      };
    ...
    <>
        ...
        <div className="relative w-full h-full max-w-[430px]">
          ...
          <div className="absolute top-6 left-1/2 -translate-x-1/2 z-30 flex items-center gap-8">
            <button
              ...
              data-ocid="explore.trending.tab"
            >
              Trending
            </button>
            <button
          ...
          <button
            ...
            data-ocid="explore.upload.open_modal_button"
          >
            <Plus size={24} />
          </button>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <video
                ...
                playsInline
                muted={muted}
                data-ocid="explore.video.canvas_target"
              />
              ...
              <div className="absolute right-3 bottom-[88px] z-20 flex flex-col items-center gap-5">
                ...
                <button
                  ...
                  data-ocid="explore.comment.button"
                >
                  <div className="w-11 h-11 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center">
                ...
                <button
                  ...
                  data-ocid="explore.share.button"
                >
                  <div className="w-11 h-11 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center">
                ...
                <button
                  ...
                  data-ocid="explore.music.button"
                >
                  <div className="w-11 h-11 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center">
      ...
      <Dialog open={uploadOpen} onOpenChange={setUploadOpen}>
        <DialogContent
          ...
          data-ocid="explore.upload.dialog"
        >
          <DialogHeader>
          ...
          <form onSubmit={handleUpload} className="space-y-4 mt-2">
            <div>
              ...
              <div className="mt-1 border-2 border-dashed border-border rounded-xl p-5 text-center hover:border-primary/50 transition-colors">
                ...
                <input
                  id="explore-video-file"
                  type="file"
                  accept="video/*"
                  className="hidden"
                  onChange={(e) => setUploadFile(e.target.files?.[0] || null)}
                  data-ocid="explore.upload.dropzone"
                />
              </div>
            </div>

            <div>
              <Label htmlFor="explore-reel-name">Reel ka naam</Label>
              <Input
                id="explore-reel-name"
                value={uploadReelName}
                onChange={(e) => setUploadReelName(e.target.value)}
                placeholder="e.g. City Vibes ✨"
                className="mt-1"
                data-ocid="explore.upload.input"
              />
            </div>

            <div>
              <Label htmlFor="explore-caption">Caption likho...</Label>
              <Textarea
                id="explore-caption"
                value={uploadCaption}
                ...
                rows={3}
                data-ocid="explore.upload.textarea"
              />
            </div>

            <div>
              <Label htmlFor="explore-hashtags">Hashtags</Label>
              <Input
                id="explore-hashtags"
                ...
                className="mt-1"
                data-ocid="explore.upload.hashtags.input"
              />
            </div>

            <div>
              <Label htmlFor="explore-tag">Profile Tag karo (@username)</Label>
              <Input
                id="explore-tag"
                value={uploadTagged}
                ...
                className="mt-1"
                data-ocid="explore.upload.tag.input"
              />
            </div>
            ...
            <div>
              ...
              <button
                ...
                data-ocid="explore.upload.music_button"
              >
            ...
            <div className="flex gap-3 pt-1">
              <Button
                ...
                data-ocid="explore.upload.cancel_button"
              >
                Cancel
              </Button>
              <Button
                ...
                className="flex-1"
                style={{ background: "oklch(var(--primary))" }}
                data-ocid="explore.upload.submit_button"
              >
                Upload Karo 🚀
              </Button>
            </div>
      ...
      <Dialog open={musicPickerOpen} onOpenChange={setMusicPickerOpen}>
        <DialogContent
          className="max-w-sm"
          data-ocid="explore.upload.music_picker"
        >
          <DialogHeader>
          ...
          <div className="mt-2 space-y-3">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9"
                data-ocid="explore.upload.music_search"
              />
            </div>
